package com.amazen._multipay.domain;
...
import com.amazen._multipay.domain.enums.TransactionStatus;
import com.amazen._multipay.domain.factories.BankInformationFactory;
import com.amazen._multipay.domain.interfaces.Observer;
import com.amazen._multipay.domain.interfaces.Subject;
...
public class MultiPayManager implements Subject {
    ...
    private com.amazen._multipay.domain.interfaces.Observer observer;
    ...
    @Override
    public void addObserver(com.amazen._multipay.domain.interfaces.Observer o) {
        observer = o;
