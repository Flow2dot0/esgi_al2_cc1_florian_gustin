...
import com.amazen._old._core.TransactionObserver;
import com.amazen._old._core.interfaces.Approver;
import com.amazen._old._multipay.domain.MultiPayManager;
import com.amazen._old._multipay.domain.entities.Transaction;
import com.amazen._old._multipay.domain.services.TransactionRegistrationService;
import com.amazen._old._multipay.infrastructure.repository.TransactionInMemoryRepository;
